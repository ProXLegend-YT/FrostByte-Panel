...
export default function Login() {
  ...
  return (
    <div className="frost-wrapper" ref={rootRef}>
      {/* Ambient layer restored — GlobalBackground's own orbs/grid are
          static (no animation), so this is the only thing on the page
          that moves. Every animated property below is transform/opacity
          only, which the GPU can composite without recalculating layout
          or repainting each frame — that's what actually removes the lag,
          not having fewer effects. */}
      <div className="frost-field" aria-hidden="true">
        <div className="frost-orb frost-orb-a" />
        <div className="frost-orb frost-orb-b" />
      </div>
      <div className="frost-grid" aria-hidden="true" />
