            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              {status !== "running" ? (
                <button 
                  ...
                  className="flex-1 md:flex-none flex items-center justify-center space-x-2 px-4 py-2 bg-cyan-500 hover:bg-sky-600 text-white font-medium rounded-lg transition-colors shadow-sm disabled:opacity-50"
                >
